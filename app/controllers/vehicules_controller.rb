class VehiculesController < ApplicationController
  ...
  def vehicule_params
    params.require(:vehicule).permit(:marque, :modele, :photo, :boite, :carburant, :kilometrage, :enregistrement, :puissancech, :puissancecv, :taille, :couleur, :prix, :carrosserie, :proprietaires, :description, :vendu, :reservation, :dioxy, :portes, :places, pictures: [])
  end
